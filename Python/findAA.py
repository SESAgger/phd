...
ref1[(ref1["AA"]!="")&(ref1["Type"]=="V")&(ref1.SIFT_txt.notna())].to_csv(args.name+"_der_transversions_sift_pp.tsv",sep="\t",columns=["CHROM","POS","AA","DER","Type","PhyloP","SIFT_score","SIFT_txt","Consequence"],index=False)
